...
if __name__ == '__main__':
    ...
    features = DNN_model.forward_features(base_predictor_variables=['Hm0','distance', 'WS10', 'PQFF10', 'WR10'], potential_predictor_variables = [['hour_avg']])
    # DNN_model.regression(['Hm0','distance', 'WS10', 'WR10', 'PQFF10'])
